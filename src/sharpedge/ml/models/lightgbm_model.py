...
Wraps LightGBM with our specific requirements:
...
class LightGBMPredictor:
    """LightGBM predictor for 1X2, O/U, and BTTS markets."""

    def __init__(self, params: dict | None = None):
        self.params = {**DEFAULT_PARAMS, **(params or {})}
        self.model_1x2: lgb.LGBMClassifier | None = None
        self.model_ou: lgb.LGBMClassifier | None = None
    ...
    def fit(
        ...
        if y_ou is not None:
            self.model_ou = lgb.LGBMClassifier(
                **self.params,
                objective="binary",
            )
